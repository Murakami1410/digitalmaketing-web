...
export default function Home() {
  return (
    <div className="">
      ...
      <section className="@conteiner bg-[#111827] relative mt-10 p-20 flex flex-col items-center justify-center relative ">
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-bold text-[48px]">Porque Escolher a Gente</h1>
          <p className="opacity-80">Oferecemos soluções abrangentes de marketing digital para ajudar sua empresa a prosperar no digital</p>
        </div>
        <div className="flex flex-row gap-8  mt-20 @sm:flex-col">
